...
class EndlessScroll(var layoutManager: LinearLayoutManager,
                             var endlessScrollListener: EndlessScrollListener) : RecyclerView.OnScrollListener() {
    ...
    override fun onScrolled(view: RecyclerView?, dx: Int, dy: Int) {
        ...
        if (!loading && lastVisibleItemPosition + visibleThreshold > totalItemCount
            ...
            currentPage++
            endlessScrollListener.onLoadMore(currentPage, totalItemCount, view)
            loading = true
        }
    }
